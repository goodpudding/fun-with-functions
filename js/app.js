...
function multiply(a, b) { //eslint-disable-line
  let productSum = a * b;
  let productString = `The product of ${a} and ${b} is ${productSum}.`;
  return [productSum, productString];
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  sumArr = tracker;
  let stringOfArr = `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${sumArr} is their sum.`;
  return [sumArr, stringOfArr];
}
